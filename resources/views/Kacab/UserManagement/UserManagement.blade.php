                        ...
                        <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                            ...
                            <td class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-600">
                                <div class="flex items-center w-full justify-center">
                                    <span class="font-monospace tracking-wider flex-grow mr-2 password-display" data-password="{{ $user->password }}">●●●●●●</span>
                            ...
                            <td
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <button onclick="openModalUpdateUser(this)"
                                        data-id="{{ $user->id }}"
                                    ...
                                    <form action="{{ route('kacab.user.delete', $user->id) }}" method="POST" class="delete-user-form">
                                        @csrf
                                        @method('DELETE')
