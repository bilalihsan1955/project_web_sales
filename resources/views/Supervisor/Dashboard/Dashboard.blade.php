                    ...
                    <table class="data-table w-full text-center border border-collapse rounded-lg overflow-hidden"
                        ...
                        <tbody id="salesmanTableBody">
                            ...
                            <tr
                                ...
                                <td class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-500">{{ $loop->iteration }}</td>
                                <td class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-500">{{ $salesman['branch'] }}</td>
                                <td class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-500">{{ $salesman['salesman']->name }}</td>
                                <td class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-500">{{ $salesman['follow_up_count'] }}</td>
                                <td class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-500">{{ $salesman['saved_count'] }}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
