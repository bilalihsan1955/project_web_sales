                    ...
                    <table id="InavlidTable" class="w-full text-sm border border-collapse rounded-lg overflow-hidden">
                        ...
                        <tbody id="InavlidTableBody">
                            ...
                            <tr class="bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                                ...
                                {{ $customers->tanggal_lahir }}</td> <!-- NoHp1 -->

                                <!-- Kolom 6: Jenis NoHp2 -->
                                <td class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-600">
                                {{ $customers->nomor_hp_1 }}</td> <!-- NoHp2 -->

                                <!-- Kolom 7: Sumber Data -->
                                <td class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-600">{{ $customers->sumber_data }}</td>
                                ...
                                <td class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-600">{{ $customers->jenis_pelanggan }}
                                </td>
                                ...
                                <td class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-600 whitespace-nowrap">
                                    <div class="flex items-center gap-2">
                                        <!-- Tombol Delete -->
                                        <form action="{{ route('admin.customer.destroy', $customers->id) }}" method="POST" class="delete-invalidCustomer-form">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
