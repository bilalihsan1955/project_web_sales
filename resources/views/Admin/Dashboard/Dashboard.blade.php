        ...
        <div class="bg-white p-4 sm:p-6 rounded-lg shadow dark:bg-gray-800">
            ...
            <div class="flex flex-col sm:flex-row items-center gap-4 sm:gap-6">
                ...
                <div class="text-center sm:text-left w-full sm:w-1/2">
                    ...
                    <div
                        class="mt-2 sm:mt-3 p-2 sm:px-4  bg-blue-50 dark:bg-blue-900 rounded-lg inline-block">
                        <span
    ...
    <div class="bg-white rounded-lg shadow dark:bg-gray-800 overflow-hidden mb-6 dark:text-gray-50">
        ...
        <div class="overflow-x-auto px-4 sm:px-6">
            ...
            <div class="w-full max-w-full overflow-x-auto">
                <table
                    class="data-table w-full text-center border border-collapse rounded-lg overflow-hidden"
                    id="salesmanTable">
                    <thead>
                        <tr class="text-center bg-gray-100 dark:bg-gray-700">
                            <th
                                class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-500 font-semibold">
                                No
                            </th>
                            <th
                                class="p-3 sm:p-4 border-b border-gray-200 dark:border-gray-500 font-semibold">
