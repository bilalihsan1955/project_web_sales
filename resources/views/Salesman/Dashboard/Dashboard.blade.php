                            ...
                            <table id="customerTable"
                                ...
                                <tbody id="customerTableBody">
                                    ...
                                    <tr
                                        ...
                                        <!-- Kolom 5: Tgl Lahir -->
                                        <td class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-600">{{ \Carbon\Carbon::parse($customer->tanggal_lahir)->format('d-m-Y') }}</td>
                                        ...
                                        <!-- Kolom 9: Keterangan -->
                                        <td class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-600">{{ $customer->alasan }}</td>

                                        <!-- Kolom 10: Aksi -->
                                        <td class="p-2 sm:p-3 border-b border-gray-200 dark:border-gray-600 whitespace-nowrap">
                                            <div class="flex items-center gap-2"> 
                                                {{-- ganti untuk jadi tombol save --}}
